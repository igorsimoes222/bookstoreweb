...
public class BookServlet extends HttpServlet {
    ...
    private void listBook(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookDAO.class.getName()).log(Level.INFO, "Total de registro: {0}", listaBook.size());
    ...
    private void showEditBookForm(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.getLogger(BookServlet.class.getName()).log(Level.INFO, "ID Solicitado: {0}", request.getParameter("id"));
